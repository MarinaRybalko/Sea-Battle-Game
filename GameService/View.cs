...
namespace GameService
{
    public class View
    {
       ...
       public void PaintCell(object sender, PaintEventArgs e)
        ...
        public void DrawRightPlayer(Label l1, Label l2, Label l3)
        {
            l1.ForeColor = l2.ForeColor = l3.ForeColor = Color.DarkGreen;
        }
        public void DrawLeftPlayer(Label l1, Label l2, Label l3)
        {
            l1.ForeColor = l2.ForeColor = l3.ForeColor = Color.Indigo;
        }
    }
}
